function [] = second_level_analysis(list_1,list_2,smooth1,smooth2,reg1,reg2,der1,der2,dossier)
    ...
    matlabbatch{1}.spm.stats.factorial_design.dir = {[data_path,'/',dossier,'/smooth_',smooth1,'_',smooth2,'/reg_',reg1,'_',reg2,'/der_',der1,'_',der2]};
    ...
    matlabbatch{2}.spm.stats.fmri_est.spmmat = {[data_path,'/',dossier,'/smooth_',smooth1,'_',smooth2,'/reg_',reg1,'_',reg2,'/der_',der1,'_',der2,'/SPM.mat']};
    matlabbatch{2}.spm.stats.fmri_est.write_residuals = 0;
    matlabbatch{2}.spm.stats.fmri_est.method.Classical = 1;
        
    matlabbatch{3}.spm.stats.con.spmmat = {[data_path,'/',dossier,'/smooth_',smooth1,'_',smooth2,'/reg_',reg1,'_',reg2,'/der_',der1,'_',der2,'/SPM.mat']};
