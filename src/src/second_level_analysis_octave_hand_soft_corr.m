function [] = second_level_analysis_octave_hand_soft_corr(list_1,list_2,smooth1,smooth2,reg1,reg2,der1,der2,soft1,soft2,folder,corr)
    ...
    if not(exist(fullfile('data',folder,['smooth_',smooth1,'_',smooth2],['reg_',reg1,'_',reg2],['der_',der1,'_',der2],filename)))
      ...
      if not(exist(fullfile('data',folder,['smooth_',smooth1,'_',smooth2],['reg_',reg1,'_',reg2],['der_',der1,'_',der2],'SPM.mat')))
        ...
        if soft1==0
            ...
            for i = 1:length(list_1)
                L1 = [L1;fullfile(data_path,'data',num2str(list_1(i)),'analysis_fsl',['smooth_',smooth1],['reg_',reg1],['der_',der1,'.feat'],'stats','cope1.nii,1')];
            end
	end
        ...
        if soft2==0
            ...
            for i = 1:length(list_2)
                L2 = [L2;fullfile(data_path,'data',num2str(list_2(i)),'analysis_fsl',['smooth_',smooth2],['reg_',reg2],['der_',der2,'.feat'],'stats','cope1.nii,1')];
            end    
        end
