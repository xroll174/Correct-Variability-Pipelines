function [] = false_positive_rate_octave_full_hand_size_corr(smooth1,smooth2,reg1,reg2,der1,der2,size,corr)
    ...
    if corr==0
        for i=1:1000
            false_positive_rate_octave(smooth1,smooth2,reg1,reg2,der1,der2,['SLA',num2str(i),'_',num2str(size),'_hand'])
        end
        ...
        for i=1:1000
            a = load(fullfile('data',['SLA',num2str(i),'_',num2str(size),'_hand'],['smooth_',smooth1,'_',smooth2],['reg_',reg1,'_',reg2],['der_',der1,'_',der2],'FPR.mat'))
        ...
        for i=1:1000
            false_positive_rate_octave_corr(smooth1,smooth2,reg1,reg2,der1,der2,['SLA',num2str(i),'_',num2str(size),'_hand'])
        end
        ...
        for i=1:1000
            a = load(fullfile('data',['SLA',num2str(i),'_',num2str(size),'_hand'],['smooth_',smooth1,'_',smooth2],['reg_',reg1,'_',reg2],['der_',der1,'_',der2],'FPR_FWE.mat'))
