...
do
	...
	rm src/design_fsf/design_fullproc_${sub[i]}_5_0_0.fsf
	
	python3 -c "import sys; sys.path.insert(1,'src/src'); from script_generation_fullproc import script_gen_fullproc; script_gen_fullproc(${sub[i]},5,0,0,'$fulldir','$fslpath');"

	feat src/design_fsf/design_fullproc_${sub[i]}_5_0_0.fsf
