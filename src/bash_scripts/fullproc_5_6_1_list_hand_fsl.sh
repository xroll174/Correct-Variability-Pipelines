...
do
    ...
    FILE=data/${sub[i]}/fsl_analysis/smooth_5/reg_6/der_1.feat/reg_standard/stats/cope1.nii
    if ! [ -f "$FILE" ]; then

	rm -r data/${sub[i]}/fsl_analysis/smooth_5/reg_6/der_1.feat

	rm src/design_fsf/design_fullproc_${sub[i]}_5_6_1.fsf
	
	python3 -c "import sys; sys.path.insert(1,'src/src'); from script_generation_fullproc import script_gen_fullproc; script_gen_fullproc(${sub[i]},5,6,1,'$fulldir','$fslpath');"

	feat src/design_fsf/design_fullproc_${sub[i]}_5_6_1.fsf

	mkdir -r data/${sub[i]}/fsl_analysis/smooth_5/reg_6/der_1.feat/reg

	scp -r data/${sub[i]}/fsl_analysis/smooth_5/reg_0/der_0.feat/reg/* data/${sub[i]}/fsl_analysis/smooth_5/reg_6/der_1.feat/reg
	
	updatefeatreg data/${sub[i]}/fsl_analysis/smooth_5/reg_6/der_1.feat -gifs
