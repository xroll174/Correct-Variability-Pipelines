function [] = second_level_analysis_octave(list_1,list_2,smooth1,smooth2,reg1,reg2,der1,der2,folder)
    ...
    if not(exist(fullfile('data',folder,['smooth_',smooth1,'_',smooth2],['reg_',reg1,'_',reg2],['der_',der1,'_',der2],'spmT_0001_thresholded.nii')))
        L1 = [];
        for i = 1:length(list_1)
            L1 = [L1;fullfile(data_path,'data',num2str(list_1(i)),'analysis',['smooth_',smooth1],['reg_',reg1],['der_',der1],'con_0001.nii,1')];
        end    

        L2 = [];
        for i = 1:length(list_2)
            L2 = [L2;fullfile(data_path,'data',num2str(list_2(i)),'analysis',['smooth_',smooth2],['reg_',reg2],['der_',der2],'con_0001.nii,1')];
        end 
        ...
        matlabbatch{2}.spm.stats.results.spmmat = {fullfile(data_path,'data',folder,['smooth_',smooth1,'_',smooth2],['reg_',reg1,'_',reg2],['der_',der1,'_',der2],'SPM.mat')};
        ...
        matlabbatch{2}.spm.stats.results.export{1}.tspm.basename = 'thresholded';
